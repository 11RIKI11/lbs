...
abstract class BaseActiveRecord
{
    ...
    public static function find($id)
    {
        ...
        $sql = "SELECT * FROM " . static::$tablename . " WHERE id = :id" . " ORDER BY id DESC LIMIT 1";
    ...
    public static function findAllByFieldAssoc(string $field, $value){
        $sql = "SELECT * FROM " . static::$tablename . " WHERE $field = :value" . " ORDER BY id DESC";
        $stmt = static::$pdo->prepare($sql);
    ...
    {
        $sql = "SELECT * FROM " . static::$tablename . " WHERE $field = :value" . " ORDER BY id DESC LIMIT 1";
        $stmt = static::$pdo->prepare($sql);
        $stmt->bindParam(':value', $value);
        $stmt->execute();
        $stmt->setFetchMode(PDO::FETCH_ASSOC);
